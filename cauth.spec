...
install -d %{buildroot}/%{_var}/www/%{name}/templates
...
%changelog
* Mon Mar 6 2017 Nicolas Hicher <nhicher@redhat.com> 0.8.0-2
- Create directories in packages
- Install config files
- Add logrotate config file

* Mon Mar 6 2017 Nicolas Hicher <nhicher@redhat.com> 0.8.0-1
- Initial packaging
